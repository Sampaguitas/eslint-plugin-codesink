/**
 * @fileOverview CWE-1321: Improperly Controlled Modification of Object Prototype Attributes ('Prototype Pollution')
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: true,
            url: "https://github.com/Sampaguitas/eslint-plugin-codesink/blob/main/docs/rules/no-prototype-pollution.md",
        },
        hasSuggestions: true
    },
    create(context) {
