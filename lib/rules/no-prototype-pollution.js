/**
 * @fileOverview Prevent improperly controlled modification of object attributes
...
const messages = {
    protoFunction: 'Improperly controlled modification of object attribute inside a function.',
}
...
module.exports = {
    meta: {
        type: 'suggestion',
        docs: {
            description: 'Prevent improperly controlled modification of object attributes',
            category: 'Possible Security Vulnerability',
            recommended: true,
            url: docsUrl('no-prototype-pollution'),
        },
        hasSuggestions: true,
        messages,
    },
        ...
        return {
            ...
            MemberExpression(node) {
                ...
                if (codeSink.isRightOperand && !codeSink.isEscaped()) {
                    report(context, messages.protoFunction, 'protoFunction', {
                        node,
                        suggest: [
                            {
